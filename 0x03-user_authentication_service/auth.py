...
class Auth:
    ...
    def valid_login(self, email: str,
                    password: str) -> bool:
        """Validates the user's login credentials and return True
        if they are correct or False if they are not
        Args:
            email (str): user's email address
            password (str): the user's password
        Return:
            True if the credentials are correct, else
            returns false
        """
        try:
    ...
    def create_session(self, email: str) -> Union[None, str]:
        """
        create a session_id for an existing user and update the
    ...
    def get_user_from_session_id(self, session_id: str) -> Union[None, U]:
        """
        Take a session_id and return the user and if not exists return
        None
        Args:
    ...
    def destroy_session(self, user_id: int) -> None:
        """
        Takes the user_id and destroys the user's session and updates
    ...
    def get_reset_password_token(self, email: str) -> str:
        """
        Generates the reset token uuid for the user by a given email
        Args:
            email (str): user's email address
        Return:
    ...
    def update_password(self, reset_token: str, password: str) -> None:
        ...
        Args:
            reset_token (str): reset_token that was generated by the
